...
namespace am.DB
{
    ...
    public class Connection
    {
        ...
        /// <summary>
        /// Вернуть экземпляр SqlCommand для текста
        /// </summary>
        ...
        /// <summary>
        /// Вернуть экземпляр SqlCommand для хранимой процедуры
        /// </summary>
        ...
        /// <summary>
        /// Получить данные из базы данных в виде DataTable
        /// </summary>
        ...
        /// <summary>
        /// Выполнить запрос к базе данных, не требующий возврата значения
        /// </summary>
        ...
        /// <summary>
        /// Получить одно единственное значение из базы данных
        /// </summary>
