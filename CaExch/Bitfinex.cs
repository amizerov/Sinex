...
namespace CaExch;
public class CaBitfinex : AnExchange
{
    public override int ID => 6;
    public override string Name => "Bitfinex";

    public override ISymbolOrderBook OrderBook => new BitfinexSymbolOrderBook(_symbol);
    string _symbol = "";

    public override List<string> Intervals => new List<string>() 
        { "1m", "5m", "1h", "1d" };

    BitfinexRestClient restClient = new();
    BitfinexSocketClient socketClient = new();
